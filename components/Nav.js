                ...
                userMenu = <div className="ui right dropdown item">
                    ...
                    <div className="menu">
                        ...
                        {parseInt(user.isSuperUser)
                            ? <NavLink className="item" routeName="users" href="/users">Users List</NavLink>
                            : ''}
                        <a href="/logout" className="item">Logout</a>
                    </div>
                </div>;
            } else {
                userMenu = <div className="ui right item">
                    <a className="ui mini circular teal button" href="/login">Sign-in</a>
                    &nbsp;
                    <a href="/register" className="ui mini circular yellow button">Register</a>
                </div>;
                configMenu = '';
            }
        }
                ...
                <nav ref="defaultNavbar" className="ui blue menu inverted navbar grid">
                    <NavLink routeName="home" className="brand item" href='http://ld-r.org'>
                        {this.props.loading
                            ...
                            : <img style={{
                                height: 22,
                                width: 22
                            }} className="ui mini image" src="/assets/img/ld-reactor.gif" alt="ld-reactor"/>}
                    </NavLink>
                    ...
                    <div className="right menu">
                        ...
                        <a href="http://github.com/ali1k/ld-r" className="ui item link">
                            <i className="github circle icon"></i>
                            Github
                        </a>
                        {userMenu}
                    </div>
